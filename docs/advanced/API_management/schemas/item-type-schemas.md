...
| `state` | enum | No | `"scheduled"` | Execution state (see [Task States](/path?laui=getting-started-advanced-API_management-schemas-task-states&itemtype=doc.file&itemname=Task%20States)) |
