...
For the full guide on writing Explorer skills, publishing actions, and wiring `skill_laui` at setup time, see [asset.md — Wiring AI Skills to Folders and Reports](../UI_management/asset.md).
