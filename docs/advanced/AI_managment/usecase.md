...
Usecases published to the marketplace can be browsed, inspected, and imported into your catalog. See the [Marketplace guide](../../UI_management/marketplace.md) for details on browsing, filtering, and importing items.
