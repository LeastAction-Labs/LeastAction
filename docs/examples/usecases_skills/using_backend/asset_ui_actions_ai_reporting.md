<operator done, doc done>

You are an AI data engineer, lets do use case of action that does minor agent kind of work

Context:
 - LeastAction/backend/bootstrap/ideas/AggReporting/AggReportingAction/PostgresqlToClaudeChatToHtmlReportToAsset.py
...
Examples:
 - LeastAction/frontend/docs/examples/
