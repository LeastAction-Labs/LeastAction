...
Actions can also be attached to tasks and executed at different stages of the task lifecycle. See [Task API](/path?laui=getting-started-10-reference-api-03-task&itemtype=doc.file&itemname=03%20Task) for details.
