...
description = (
    "Five HTML report tasks that run after the postgresql-attendance-endtoend completes. "
...
guide_docs = """\
# Badge Attendance Reports — Setup Guide

> Reporting half of the badge-attendance end-to-end capstone. Runs after `postgresql-attendance-endtoend`.
...
metadata = {
    ...
    "category": "End-to-End",
    "tags": [
        "flavor:S+P", "lifecycle:end-to-end", "reporting",
        "badge", "attendance", "html", "claude",
