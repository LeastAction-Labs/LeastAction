...
skill = {
    "description": "Operators and actions for GCP Storage services: Cloud Storage (GCS), Filestore, Storage Transfer Service, Cloud Backup and DR, and more.",
    "content": """You are a LeastAction AI engineer. Help the user create **operators** and **actions** for Google Cloud Storage services to orchestrate data movement, archival, file operations, and transfer workflows via LeastAction.
...
prompt = "AI skill for generating LeastAction operators and actions targeting GCP Storage services (Cloud Storage/GCS, Filestore, Storage Transfer Service, Cloud Backup and DR)."

install_docs = "Attach as a skill to a LeastAction AI chat or task. No additional dependencies required."

guide_docs = "Guides the AI to generate operators and actions for GCP Storage: GCS object operations and lifecycle management, Filestore NFS operations, Storage Transfer Service jobs, Cloud Backup and DR policies. Uses service account authentication."

description = "AI skill — generates LeastAction operators and actions for GCP Storage services including Cloud Storage (GCS), Filestore, Storage Transfer Service, and Cloud Backup and DR."
...
metadata = {
    "service": "GCP Storage",
    "category": "AI Skill",
    "tags": ["gcp", "storage", "gcs", "filestore", "storage-transfer", "backup", "skill", "ai"]
}
