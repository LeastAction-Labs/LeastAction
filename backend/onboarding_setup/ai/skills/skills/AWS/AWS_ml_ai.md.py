...
skill = {
    "description": "Operators and actions for AWS ML and AI services: SageMaker, Bedrock, Rekognition, Textract, Comprehend, Forecast, and more.",
    "content": """You are a LeastAction AI engineer. Help the user create **operators** and **actions** for AWS Machine Learning and AI services to orchestrate model training, inference, and intelligent document/data processing workflows via LeastAction.
...
prompt = "AI skill for generating LeastAction operators and actions targeting AWS ML and AI services (SageMaker, Bedrock, Rekognition, Textract, Comprehend, Forecast)."

install_docs = "Attach as a skill to a LeastAction AI chat or task. No additional dependencies required."

guide_docs = "Guides the AI to generate operators and actions for AWS ML/AI: SageMaker training jobs and inference, Bedrock LLM invocations, Rekognition image analysis, Textract document extraction, Comprehend NLP, Forecast predictions. Uses IAM role authentication."

description = "AI skill — generates LeastAction operators and actions for AWS Machine Learning and AI services including SageMaker, Bedrock, Rekognition, Textract, Comprehend, and Forecast."
...
metadata = {
    "service": "AWS ML/AI",
    "category": "AI Skill",
    "tags": ["aws", "ml", "ai", "sagemaker", "bedrock", "rekognition", "textract", "comprehend", "forecast", "skill"]
}
