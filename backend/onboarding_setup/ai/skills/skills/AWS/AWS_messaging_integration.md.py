...
skill = {
    "description": "Operators and actions for AWS Messaging and Integration services: SQS, SNS, EventBridge, Step Functions, Kinesis, AppFlow, and more.",
    "content": """You are a LeastAction AI engineer. Help the user create **operators** and **actions** for AWS Messaging and Application Integration services to orchestrate event-driven workflows, queuing, and pipeline coordination via LeastAction.
...
prompt = "AI skill for generating LeastAction operators and actions targeting AWS Messaging and Integration services (SQS, SNS, EventBridge, Step Functions, Kinesis, AppFlow)."

install_docs = "Attach as a skill to a LeastAction AI chat or task. No additional dependencies required."

guide_docs = "Guides the AI to generate operators and actions for AWS Messaging: SQS queue operations, SNS publish/subscribe, EventBridge rules, Step Functions state machines, Kinesis streams, AppFlow integrations. Uses IAM role authentication."

description = "AI skill — generates LeastAction operators and actions for AWS Messaging and Integration services including SQS, SNS, EventBridge, Step Functions, and AppFlow."
...
metadata = {
    ...
    "category": "AI Skill",
    "tags": ["aws", "messaging", "sqs", "sns", "eventbridge", "step-functions", "kinesis", "appflow", "skill", "ai"]
}
