...
skill = {
    "description": "Operators and actions for AWS Security and Identity services: IAM, Secrets Manager, KMS, GuardDuty, Security Hub, CloudTrail, Config, and more.",
    "content": """You are a LeastAction AI engineer. Help the user create **operators** and **actions** for AWS Security and Identity services to orchestrate credential management, compliance checks, audit logging, and access control workflows via LeastAction.
...
prompt = "AI skill for generating LeastAction operators and actions targeting AWS Security and Identity services (IAM, Secrets Manager, KMS, GuardDuty, Security Hub, CloudTrail)."

install_docs = "Attach as a skill to a LeastAction AI chat or task. No additional dependencies required."

guide_docs = "Guides the AI to generate operators and actions for AWS Security: IAM role management, Secrets Manager credential retrieval, KMS encryption, GuardDuty findings, Security Hub compliance, CloudTrail audit logs. Uses IAM role authentication."

description = "AI skill — generates LeastAction operators and actions for AWS Security and Identity services including IAM, Secrets Manager, KMS, GuardDuty, Security Hub, and CloudTrail."
...
metadata = {
    ...
    "category": "AI Skill",
    "tags": ["aws", "security", "iam", "secrets-manager", "kms", "guardduty", "security-hub", "cloudtrail", "skill", "ai"]
}
