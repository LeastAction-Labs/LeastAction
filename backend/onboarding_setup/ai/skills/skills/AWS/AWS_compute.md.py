...
skill = {
    "description": "Operators and actions for AWS Compute services: EC2, Lambda, Batch, ECS, EKS, Fargate, and more.",
    "content": """You are a LeastAction AI engineer. Help the user create **operators** and **actions** for AWS Compute services to orchestrate job execution, container workloads, and serverless functions via LeastAction.
...
prompt = "AI skill for generating LeastAction operators and actions targeting AWS Compute services (EC2, Lambda, Batch, ECS, EKS, Fargate)."

install_docs = "Attach as a skill to a LeastAction AI chat or task. No additional dependencies required."

guide_docs = "Guides the AI to generate operators and actions for AWS Compute: EC2 instance management, Lambda invocation, Batch job submission, ECS/EKS container workloads, Fargate tasks. Uses IAM role authentication."

description = "AI skill — generates LeastAction operators and actions for AWS Compute services including EC2, Lambda, Batch, ECS, EKS, and Fargate."
...
metadata = {
    "service": "AWS Compute",
    "category": "AI Skill",
    "tags": ["aws", "compute", "ec2", "lambda", "batch", "ecs", "eks", "fargate", "skill", "ai"]
}
