...
skill = {
    "description": "Operators and actions for AWS Analytics services: Glue, Athena, Redshift, EMR, Kinesis, and more.",
    "content": """You are a LeastAction AI engineer. Help the user create **operators** and **actions** for AWS Analytics services to orchestrate data pipelines, transformations, and reporting workflows via LeastAction.
...
prompt = "AI skill for generating LeastAction operators and actions targeting AWS Analytics services (Glue, Athena, Redshift, EMR, Kinesis)."

install_docs = "Attach as a skill to a LeastAction AI chat or task. No additional dependencies required."

guide_docs = "Guides the AI to generate operators and actions for AWS Analytics: Glue ETL, Athena queries, Redshift loads, EMR Spark jobs, Kinesis streams. Uses IAM role authentication — no explicit credentials stored."

description = "AI skill — generates LeastAction operators and actions for AWS Analytics services including Glue, Athena, Redshift, EMR, and Kinesis."
...
metadata = {
    ...
    "category": "AI Skill",
    "tags": ["aws", "analytics", "glue", "athena", "redshift", "emr", "kinesis", "skill", "ai"]
}
